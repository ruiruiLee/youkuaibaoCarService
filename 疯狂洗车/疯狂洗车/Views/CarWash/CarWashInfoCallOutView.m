...
@implementation CarWashInfoCallOutView
       ...
       withClubMode:(BOOL)isClub
{
    ...
    if (self)
    {
        ...
        _priceLabel.textColor = self.isClubMode?[UIColor colorWithRed:227/255.0
                                                                green:174/255.0
                                                                 blue:82/255.0
                                                                alpha:1.0]:[UIColor colorWithRed:235.0/255.0
                                                                                           green:84.0/255.0
                                                                                            blue:1.0/255.0
                                                                                           alpha:1.0];
...
- (void)setDisplayCarWashInfo:(CarWashModel*)model
{
    ...
    NSString *priceString = [NSString stringWithFormat:@"¥%@",model.car_member_price];
    ...
    NSString *oldPiceString = [NSString stringWithFormat:@"¥%@",model.car_original_price];
    ...
    _oldPriceLabel.frame = CGRectMake(_priceLabel.frame.origin.x+_priceLabel.frame.size.width+2, _priceLabel.frame.origin.y+1, oldPiceSize.width, 15);
