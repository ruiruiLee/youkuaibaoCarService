...
@implementation FourServiceListCell

- (void)awakeFromNib
{
    // Initialization code
    _carNurseImageView.layer.masksToBounds = YES;
    _carNurseImageView.layer.cornerRadius = 85/2.0;
    _carNurseImageView.layer.borderWidth = 1;
    _carNurseImageView.layer.borderColor = [UIColor colorWithRed:227/255.0
                                                           green:227/255.0
                                                            blue:227/255.0
                                                           alpha:0.5].CGColor;
}
...
- (void)setDisplayInfo:(CarNurseModel*)model
{
    ...
    _priceLabel.text = [NSString stringWithFormat:@"￥%@起",model.member_price];
