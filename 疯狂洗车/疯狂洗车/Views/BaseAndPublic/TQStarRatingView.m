...
- (void)commonInit
{
    self.starBackgroundView = [self buidlStarViewWithImageName:self.tag<0?kBACKGROUND_CLUB_STAR:kBACKGROUND_STAR];
    self.starForegroundView = [self buidlStarViewWithImageName:self.tag<0?kFOREGROUND_CLUB_STAR:kFOREGROUND_STAR];
    [self addSubview:self.starBackgroundView];
    [self addSubview:self.starForegroundView];
    [self setScore:1.0 withAnimation:NO];
}
