...
+ (NSArray *)polylinesForSegment:(AMapSegment *)segment
{
    ...
    MAPolyline *busLinePolyline = [self polylineForBusLine:[segment.buslines lastObject]];
                           ...
                           Polylines:(NSMutableArray *)polylines
{
    if (lastSegment)
    {
        ...
        MAPolyline *busLinePolyline = [self polylineForBusLine:[(lastSegment).buslines lastObject]];
        if (busLinePolyline != nil)
        {
