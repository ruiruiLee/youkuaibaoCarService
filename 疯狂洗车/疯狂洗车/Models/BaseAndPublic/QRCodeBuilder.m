...
+ (UIImage *) twoDimensionCodeImage:(UIImage *)twoDimensionCode withAvatarImage:(UIImage *)avatarImage
{
    ...
    [[self avatarImage:avatarImage] drawInRect:CGRectMake((size.width - size2.width) / 2.0,
                                                          (size.height - size2.height) / 2.0,
                                                          size2.width,
                                                          size2.height)];
...
{
    UIImage * avatarBackgroudImage = [UIImage imageNamed:@"left_menu_bottom_icon"];
